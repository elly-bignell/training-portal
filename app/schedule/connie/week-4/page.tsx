// app/schedule/connie/week-4/page.tsx
...
function ConnieWeek4Content() {
  const days = ["Mon 16 Mar", "Tue 17 Mar", "Wed 18 Mar", "Thu 19 Mar", "Fri 20 Mar"];
  ...
  return (
    <main className="min-h-screen bg-slate-100">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">Week 4 — Wrapping Up Phase 1 · Mon 16 Mar – Fri 20 Mar 2026</p>
              </div>
            </div>
            <div className="flex items-center gap-2">

              <Link href={`/schedule/connie/week-3`} className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-700 hover:bg-slate-600 text-slate-300 text-xs font-semibold rounded-lg transition-colors">
              ...
              <span className="px-3 py-1.5 bg-slate-700 text-slate-300 text-xs font-semibold rounded-full">
                ...
                Week 4 — Buddy Observe

              </span>

              <Link href={`/schedule/connie/week-5`} className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-700 hover:bg-slate-600 text-slate-300 text-xs font-semibold rounded-lg transition-colors">
      ...
      <div className="max-w-[1600px] mx-auto px-4 py-6 space-y-8">
        {/* Week 4 Targets Banner */}
        <div className="bg-gradient-to-r from-slate-800 to-slate-900 rounded-xl p-5 text-white">
          <div className="flex items-center gap-2 mb-3">
            <span className="text-lg">🎯</span>
            <h2 className="text-sm font-bold uppercase tracking-wide">Week 4 Daily Targets</h2>
          </div>
                  ...
                  <tr>
                    ...
                    {days.map((day) => (
                      <td key={day} rowSpan={2} className="p-2 text-center border border-gray-200 align-middle bg-emerald-50">
                        ...
                        <div className="text-[10px] text-emerald-600 font-semibold mt-1">Last week at this rhythm — next week you step up to 2 meetings</div>
                      </td>
                    ))}
                  </tr>
          ...
          <div className="w-[420px] flex-shrink-0 space-y-6">
            ...
            <div className="bg-amber-50 rounded-xl border border-amber-200 p-4">
              <div className="flex items-start gap-2">
                ...
                <p className="text-xs text-amber-800 leading-relaxed">20% book rate at peak — your booking rhythm is locked in.</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-xs text-gray-700 leading-relaxed">Last week at 1 meeting/day — next week you step up to 2</p>
                </div>
                <div className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-slate-400 mt-1.5 flex-shrink-0"></div>
                  <p className="text-xs text-gray-700 leading-relaxed">Your booking rhythm should be locked in by now</p>
                </div>
                <div className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-slate-400 mt-1.5 flex-shrink-0"></div>
                  <p className="text-xs text-gray-700 leading-relaxed">Focus on quality over quantity — better bookings = better show rates</p>
                </div>
                <div className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-slate-400 mt-1.5 flex-shrink-0"></div>
...
export default function ConnieWeek4Page() {
  return (
