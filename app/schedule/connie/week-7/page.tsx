// app/schedule/connie/week-7/page.tsx
...
function ConnieWeek7Content() {
  const days = ["Mon 6 Apr", "Tue 7 Apr", "Wed 8 Apr", "Thu 9 Apr", "Fri 10 Apr"];

  const WEEK_PHONE_HOURS = 5.5;
  const BLOCK1_HOURS = 3;
  const BLOCK2_HOURS = 2.5;
  ...
  return (
    <main className="min-h-screen bg-slate-100">
      ...
      <div className="max-w-[1600px] mx-auto px-4 py-6 space-y-8">
        ...
        {/* Week 7 Targets Banner */}
        <div className="bg-gradient-to-r from-slate-800 to-slate-900 rounded-xl p-5 text-white">
          <div className="flex items-center gap-2 mb-3">
            <span className="text-lg">🎯</span>
            <h2 className="text-sm font-bold uppercase tracking-wide">Week 7 Daily Targets</h2>
          </div>
          ...
          <p className="text-xs text-slate-400 mt-3">100% of revenue goes to your target — no more buddy split</p>
        </div>
              ...
              <table className="w-full text-sm border-collapse">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    {days.map((day) => (
                      <td key={day} rowSpan={2} className="p-2 text-center border border-gray-200 align-middle bg-emerald-50">
                        <div className="bg-emerald-100 text-emerald-700 rounded px-2 py-2 text-xs font-semibold">📋 Meeting (Solo) 1</div>
                  ...
                  <tr>
                    ...
                    {days.map((day) => (
                      <td key={day} rowSpan={2} className="p-2 text-center border border-gray-200 align-middle bg-emerald-50">
                        <div className="bg-emerald-100 text-emerald-700 rounded px-2 py-2 text-xs font-semibold">📋 Meeting (Solo) 2</div>
          ...
          <div className="w-[420px] flex-shrink-0 space-y-6">
              ...
              <table className="w-full text-xs border-collapse">
                ...
                <tbody>
                  ...
                  <tr className="border-b border-gray-100 bg-emerald-50/50">
                    <td className="py-2 text-emerald-700 font-medium">📋 Meeting (Solo) 1</td>
            ...
            <div className="bg-emerald-50 border-emerald-200 rounded-xl border p-4">
              <div className="flex items-start gap-2">
                ...
                <p className="text-xs text-emerald-800 leading-relaxed">Same rhythm — but every deal is 100% yours now.</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-xs text-gray-700 leading-relaxed">First week flying solo — 100% of every deal counts to your target</p>
                </div>
                <div className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-slate-400 mt-1.5 flex-shrink-0"></div>
                  <p className="text-xs text-gray-700 leading-relaxed">Same rhythm: calls, bookings, meetings — but all yours now</p>
                </div>
                <div className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-slate-400 mt-1.5 flex-shrink-0"></div>
                  <p className="text-xs text-gray-700 leading-relaxed">Prove you can maintain the close rate without your buddy</p>
                </div>
                <div className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-slate-400 mt-1.5 flex-shrink-0"></div>
                ...
                <div className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-slate-400 mt-1.5 flex-shrink-0"></div>
                  <p className="text-xs text-gray-700 leading-relaxed">100% commission — every deal goes straight to your monthly target</p>
                </div>
              </div>
            </div>
...
export default function ConnieWeek7Page() {
  return (
