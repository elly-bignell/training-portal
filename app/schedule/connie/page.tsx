...
function ConnieScheduleContent() {
  const competencies = [
    ...
    <main className="min-h-screen bg-slate-100">
        ...
        <div className="max-w-[1600px] mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <Link href="/schedule/connie" className="text-slate-400 hover:text-white transition-colors" title="Back to Portal">
      ...
      <div className="max-w-[1600px] mx-auto px-4 py-6 space-y-8">
        <div className="flex gap-6">
          ...
          <div className="w-[420px] flex-shrink-0 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <Link href="/trainees/connie-matthews" className="flex items-center gap-3 p-3 rounded-lg border border-gray-200 hover:border-blue-300 hover:bg-blue-50 transition-all group">
        ...
        <div className="mt-6 text-center">
          <Link href="/schedule/connie" className="inline-flex items-center gap-2 text-sm text-slate-500 hover:text-slate-700 transition-colors">← Back</Link>
        </div>
      </div>
    </main>
  );
...
export default function ConnieSchedulePage() {
  return (
    <PasswordGate traineeSlug="connie-matthews">
      <ConnieScheduleContent />
    </PasswordGate>
  );
}
