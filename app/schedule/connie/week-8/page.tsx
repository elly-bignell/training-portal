// app/schedule/connie/week-8/page.tsx
      ...
      <div className="max-w-[1600px] mx-auto px-4 py-6 space-y-8">
        ...
        <div className="bg-gradient-to-r from-slate-800 to-slate-900 rounded-xl p-5 text-white">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h2 className="text-sm font-bold uppercase tracking-wide">Week 8 Daily Targets</h2>
          </div>
          ...
          <p className="text-xs text-slate-400 mt-3">The Standard — maintain this consistently from here on</p>
        </div>
        ...
        <div className="flex gap-6">
          ...
          <div className="w-[420px] flex-shrink-0 space-y-6">
            ...
            {/* Efficiency Note */}
            <div className="bg-pink-50 border-pink-200 rounded-xl border p-4">
              <div className="flex items-start gap-2">
                <span className="text-pink-500 mt-0.5">🎯</span>
                <p className="text-xs text-pink-800 leading-relaxed">The Standard is your floor, not your ceiling — keep pushing.</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-xs text-gray-700 leading-relaxed">This is The Standard — your benchmark from here on</p>
                </div>
                <div className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-slate-400 mt-1.5 flex-shrink-0"></div>
                  <p className="text-xs text-gray-700 leading-relaxed">Fully proficient closed-circuit selling — you own the entire process</p>
                </div>
                <div className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-slate-400 mt-1.5 flex-shrink-0"></div>
                ...
                <div className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-slate-400 mt-1.5 flex-shrink-0"></div>
                  <p className="text-xs text-gray-700 leading-relaxed">The Standard is your floor, not your ceiling — keep pushing</p>
                </div>
              </div>
            </div>
...
export default function ConnieWeek8Page() {
  return (
