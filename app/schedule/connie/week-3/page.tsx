// app/schedule/connie/week-3/page.tsx
...
function ConnieWeek3Content() {
  const days = ["Mon 9 Mar", "Tue 10 Mar", "Wed 11 Mar", "Thu 12 Mar", "Fri 13 Mar"];
  ...
  return (
    <main className="min-h-screen bg-slate-100">
        ...
        <div className="max-w-[1600px] mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <Link href={`/schedule/connie/week-2`} className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-700 hover:bg-slate-600 text-slate-300 text-xs font-semibold rounded-lg transition-colors">
              ...
              <span className="px-3 py-1.5 bg-slate-700 text-slate-300 text-xs font-semibold rounded-full">
                ...
                Week 3 — Buddy Observe

              </span>

              <Link href={`/schedule/connie/week-4`} className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-700 hover:bg-slate-600 text-slate-300 text-xs font-semibold rounded-lg transition-colors">
      ...
      <div className="max-w-[1600px] mx-auto px-4 py-6 space-y-8">
        {/* Week 3 Targets Banner */}
        <div className="bg-gradient-to-r from-slate-800 to-slate-900 rounded-xl p-5 text-white">
          <div className="flex items-center gap-2 mb-3">
            <span className="text-lg">🎯</span>
            <h2 className="text-sm font-bold uppercase tracking-wide">Week 3 Daily Targets</h2>
          </div>
                  ...
                  <tr>
                    ...
                    {days.map((day) => (
                      <td key={day} rowSpan={2} className="p-2 text-center border border-gray-200 align-middle bg-emerald-50">
                        ...
                        <div className="text-[10px] text-emerald-600 font-semibold mt-1">Your booking quality should be improving — better prospects</div>
                      </td>
                    ))}
                  </tr>
          ...
          <div className="w-[420px] flex-shrink-0 space-y-6">
            ...
            <div className="bg-amber-50 rounded-xl border border-amber-200 p-4">
              <div className="flex items-start gap-2">
                ...
                <p className="text-xs text-amber-800 leading-relaxed">20% book rate locked in — consistency is the goal this week.</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-xs text-gray-700 leading-relaxed">Consistency is the goal — hit your numbers every single day</p>
                </div>
                <div className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-slate-400 mt-1.5 flex-shrink-0"></div>
                  <p className="text-xs text-gray-700 leading-relaxed">Your booking quality should be improving — fewer no-shows</p>
                </div>
                <div className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-slate-400 mt-1.5 flex-shrink-0"></div>
                  <p className="text-xs text-gray-700 leading-relaxed">Learn from every meeting — what objections come up?</p>
                </div>
                <div className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-slate-400 mt-1.5 flex-shrink-0"></div>
...
export default function ConnieWeek3Page() {
  return (
