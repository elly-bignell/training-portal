...
const PERSON_SLUG = "connie";
const PERSON_NAME = "Connie Matthews";
const BUDDY_NAME = "Felipe Garcia";
const SCORECARD_SLUG = "connie-matthews";
const CURRENT_WEEK = 2;
const TOTAL_WEEKS = 8;
const WEEK_PHONE_HOURS = 5.5; // 3hrs block 1 + 2.5hrs block 2
...
function ConnieWeek2Content() {
  // Pull rates from projections page (single source of truth)
  ...
  // Compute targets using this week's calling hours
  ...
  // Booking targets per block (proportional to hours)
  const block1Hours = 3;
  ...
  return (
    <main className="min-h-screen bg-slate-100">
      ...
      <div className="max-w-[1600px] mx-auto px-4 py-6 space-y-8">
        {/* Week Targets Banner — dynamic from projections */}
