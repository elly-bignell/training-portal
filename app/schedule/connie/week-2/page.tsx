// app/schedule/connie/week-2/page.tsx
                  ...
                  <tr>
                    ...
                    {days.map((day) => (
                      <td key={day} rowSpan={2} className="p-2 text-center border border-gray-200 align-middle bg-emerald-50">
                        ...
                        <div className="text-[10px] text-emerald-600 font-semibold mt-1">Observe your buddy — learn the pitch structure</div>
                      </td>
                    ))}
                  </tr>
          ...
          <div className="w-[420px] flex-shrink-0 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-slate-400 mt-1.5 flex-shrink-0"></div>
                  <p className="text-xs text-gray-700 leading-relaxed">Meeting time: observe how your buddy handles objections and closes</p>
                </div>
                <div className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-slate-400 mt-1.5 flex-shrink-0"></div>
...
export default function ConnieWeek2Page() {
  return (
