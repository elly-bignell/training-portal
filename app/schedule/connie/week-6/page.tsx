// app/schedule/connie/week-6/page.tsx
  ...
  return (
    <main className="min-h-screen bg-slate-100">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">Week 6 — Final Buddy Week · Mon 30 Mar – Fri 3 Apr 2026</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              ...
              <span className="px-3 py-1.5 bg-slate-700 text-slate-300 text-xs font-semibold rounded-full">
                ...
                Week 6 — Final Buddy Week

              </span>

              <Link href={`/schedule/connie/week-7`} className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-700 hover:bg-slate-600 text-slate-300 text-xs font-semibold rounded-lg transition-colors">
      ...
      <div className="max-w-[1600px] mx-auto px-4 py-6 space-y-8">
        {/* Week 6 Targets Banner */}
        <div className="bg-gradient-to-r from-slate-800 to-slate-900 rounded-xl p-5 text-white">
          <div className="flex items-center gap-2 mb-3">
            <span className="text-lg">🎯</span>
            <h2 className="text-sm font-bold uppercase tracking-wide">Week 6 Daily Targets</h2>
          </div>
          ...
          <div className="w-[420px] flex-shrink-0 space-y-6">
            ...
            <div className="bg-amber-50 border-amber-200 rounded-xl border p-4">
              <div className="flex items-start gap-2">
                ...
                <p className="text-xs text-amber-800 leading-relaxed">Same rhythm as Week 5 — lock it in before going solo.</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-xs text-gray-700 leading-relaxed">This is your last week with buddy support — make it count</p>
                </div>
                <div className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-slate-400 mt-1.5 flex-shrink-0"></div>
                  <p className="text-xs text-gray-700 leading-relaxed">Prove you can run the full meeting and close independently</p>
                </div>
                <div className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-slate-400 mt-1.5 flex-shrink-0"></div>
                ...
                <div className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-slate-400 mt-1.5 flex-shrink-0"></div>
                  <p className="text-xs text-gray-700 leading-relaxed">Revenue split 50/50 with buddy — last week of split commission</p>
                </div>
              </div>
            </div>
...
export default function ConnieWeek6Page() {
  return (
