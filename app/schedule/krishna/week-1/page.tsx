    ...
    <main className="min-h-screen bg-slate-100">
        ...
        <div className="max-w-[1600px] mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <Link href="/schedule/krishna" className="text-slate-400 hover:text-white transition-colors" title="Back to Schedule">
      ...
      <div className="max-w-[1600px] mx-auto px-4 py-6 space-y-8">
          ...
          <div className="w-[420px] flex-shrink-0 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-2">
                <Link href="/scorecard/krishna-patel" className="flex items-center gap-3 p-3 rounded-lg border border-gray-200 hover:border-pink-300 hover:bg-pink-50 transition-all group">
        ...
        <div className="mt-6 text-center">
          <Link href="/schedule/krishna" className="inline-flex items-center gap-2 text-sm text-slate-500 hover:text-slate-700 transition-colors">← Back to Schedule</Link>
        </div>
      </div>
    </main>
  );
...
export default function KrishnaWeek1Page() {
  return (
