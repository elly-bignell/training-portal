...
function SchedulePageContent() {
  const emptyCell = "p-3 text-center border border-gray-200/60";
  const timeCell = "p-3 font-medium text-gray-400 border border-gray-200/60 bg-gray-50/50 text-xs whitespace-nowrap";
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 overflow-x-auto">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td rowSpan={3} className="p-3 text-center border border-gray-200 align-top bg-sky-50">
                    ...
                    <div className="text-[10px] text-gray-500 italic">Others on Resources</div>
                  </td>
                  <td rowSpan={3} className="p-3 text-center border border-gray-200 align-top bg-sky-50">
                    <div className="bg-sky-100 text-sky-700 rounded px-2 py-1.5 text-xs font-semibold">📞 Felipe Call Training</div>
                    <div className="text-[10px] text-gray-500 mt-1">9:00am – 12:00pm · 3hr rotation</div>
                ...
                <tr>
                  ...
                  <td rowSpan={2} className="p-3 text-center border border-gray-200 align-middle bg-purple-50">
                    <div className="bg-purple-100 text-purple-700 rounded px-2 py-1.5 text-xs font-semibold">Reviewing Resources</div>
                ...
                <tr>
                  ...
                  <td rowSpan={2} className="p-3 text-center border border-gray-200 align-middle bg-teal-50">
                    <div className="bg-teal-100 text-teal-700 rounded px-2 py-1.5 text-xs font-semibold">Customer Service</div>
                    <div className="text-[10px] text-gray-500 mt-1.5">1:00–3:00pm · 2hrs</div>
          ...
          <div className="mt-6 pt-4 border-t border-gray-100 flex flex-wrap gap-4 text-xs">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-gray-600">Content Sessions</span>
            </div>
            <div className="flex items-center gap-1.5">
            ...
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                ...
                <tr className="bg-blue-50/50">
                  <td className="p-3 font-medium text-gray-500 border border-gray-200/60 text-xs whitespace-nowrap">✈️ Arrivals</td>
                  <td className="p-3 text-center border border-gray-200/60 text-xs">
                    <div className="font-semibold text-blue-700">Cindy</div>
                    <div className="text-gray-500">Sydney → Adelaide</div>
                    <div className="text-gray-500">QF731 · Lands 8:15am</div>
                    <div className="mt-1.5 font-semibold text-blue-700">Becks</div>
                ...
                {/* ── 9:00–10:00 ── */}
                <tr>
                  <td className={timeCell}>9:00–10:00am</td>
                  <td className={emptyCell}></td>
                  <td className={emptyCell}></td>
                  <td className={emptyCell}></td>
                  <td className={emptyCell}></td>
                ...
                {/* ── 10:00–11:00 ── */}
                <tr>
                  <td className={timeCell}>10:00–11:00am</td>
                  <td className={emptyCell}></td>
                  <td className={emptyCell}></td>
                  <td className={emptyCell}></td>
                  <td className={emptyCell}></td>
                ...
                {/* ── 11:00–12:00 ── */}
                <tr>
                  <td className={timeCell}>11:00–12:00pm</td>
                  <td className={emptyCell}></td>
                  <td className={emptyCell}></td>
                  <td className={emptyCell}></td>
                  <td className={emptyCell}></td>
                ...
                {/* ── 12:00–1:00 ── */}
                <tr>
                  <td className={timeCell}>12:00–1:00pm</td>
                  <td className={emptyCell}></td>
                  <td className={emptyCell}></td>
                  <td className={emptyCell}></td>
                  <td className={emptyCell}></td>
                ...
                {/* ── 1:00–2:00 ── */}
                <tr>
                  <td className={timeCell}>1:00–2:00pm</td>
                  <td className={emptyCell}></td>
                  <td className={emptyCell}></td>
                  <td className={emptyCell}></td>
                  <td className={emptyCell}></td>
                ...
                {/* ── 2:00–3:00 ── */}
                <tr>
                  <td className={timeCell}>2:00–3:00pm</td>
                  <td className={emptyCell}></td>
                  <td className={emptyCell}></td>
                  <td className={emptyCell}></td>
                  <td className={emptyCell}></td>
                ...
                {/* ── 3:00–4:00 ── */}
                <tr>
                  <td className={timeCell}>3:00–4:00pm</td>
                  <td className={emptyCell}></td>
                  <td className={emptyCell}></td>
                  <td className={emptyCell}></td>
                  <td className={emptyCell}></td>
                ...
                {/* ── 4:00–5:00 ── */}
                <tr>
                  <td className={timeCell}>4:00–5:00pm</td>
                  <td className={emptyCell}></td>
                  <td className={emptyCell}></td>
                  <td className={emptyCell}></td>
                  <td className={emptyCell}></td>
                ...
                {/* ── Departures ── */}
                <tr className="bg-blue-50/50">
                  <td className="p-3 font-medium text-gray-500 border border-gray-200/60 text-xs whitespace-nowrap">✈️ Departures</td>
                  <td className={emptyCell}></td>
                  <td className={emptyCell}></td>
                  <td className={emptyCell}></td>
                  <td className={emptyCell}></td>
                ...
                {/* ── Evening ── */}
                <tr>
                  <td className={timeCell}>🌙 Evening</td>
                  <td className={emptyCell}></td>
                  <td className={emptyCell}></td>
                  <td className={emptyCell}></td>
                  <td className={emptyCell}></td>
