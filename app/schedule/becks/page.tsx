        ...
        <div className="max-w-[1600px] mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-xl font-bold">Becks Hatzis</h1>
        ...
        <div className="flex gap-6">
              ...
              <table className="w-full text-sm border-collapse">
                ...
                <tbody>
                  ...
                  <tr className="bg-blue-50">
                    <td className="p-2 font-medium text-gray-700 border border-gray-200 text-xs whitespace-nowrap">✈️ Arrival</td>
                  ...
                  <tr>
                    ...
                    {/* MON: Welcome 10:00-12:30 = 5 rows */}
                    <td rowSpan={5} className="p-2 text-center border border-gray-200 align-middle bg-purple-50">
                  ...
                  {/* ── Departure ── */}
                  <tr className="bg-blue-50">
                    <td className="p-2 font-medium text-gray-700 border border-gray-200 text-xs whitespace-nowrap">✈️ Departure</td>
                    <td className="p-2 text-center border border-gray-200 text-gray-400">—</td>
                    <td className="p-2 text-center border border-gray-200 text-gray-400">—</td>
                    <td className="p-2 text-center border border-gray-200 text-gray-400">—</td>
                    <td className="p-2 text-center border border-gray-200 text-gray-400">—</td>
          ...
          <div className="w-[420px] flex-shrink-0 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <Link href="/trainees/becks-hatzis" className="flex items-center gap-3 p-3 rounded-lg border border-gray-200 hover:border-blue-300 hover:bg-blue-50 transition-all group">
