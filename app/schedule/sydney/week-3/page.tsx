// app/schedule/sydney/week-3/page.tsx
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">Week 3 — Consistency · Mon 14 Apr – Fri 18 Apr 2026</p>
              </div>
            </div>
            <div className="flex items-center gap-2">

              <Link href={`/schedule/sydney/week-2`} className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-700 hover:bg-slate-600 text-slate-300 text-xs font-semibold rounded-lg transition-colors">
...
export default function SydneyWeek3Page() {
  return (
