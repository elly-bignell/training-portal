// app/schedule/sydney/week-2/page.tsx
...
const PERSON_SLUG = "sydney";
const PERSON_NAME = "Sydney Patel";
const BUDDY_NAME = "Dylan Munro";
const SCORECARD_SLUG = "sydney-patel";
...
export default function SydneyWeek2Page() {
  return (
