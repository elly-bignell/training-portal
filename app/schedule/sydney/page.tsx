      ...
      <header className="bg-slate-900 text-white">
        <div className="max-w-4xl mx-auto px-4 py-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-2xl font-bold">Sydney Arnold</h1>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="space-y-3">
          {weeks.map((w) => (
            <Link
              key={w.week}
              href={`/schedule/sydney/week-${w.week}`}
...
export default function SydneySchedulePage() {
  return (
    <PasswordGate traineeSlug="sydney-patel">
      <SydneyScheduleContent />
    </PasswordGate>
  );
}
