// app/schedule/sydney/week-4/page.tsx
...
function SydneyWeek4Content() {
  const days = ["Mon 22 Apr", "Tue 23 Apr", "Wed 24 Apr", "Thu 24 Apr", "Fri 25 Apr"];
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">Week 4 — Wrapping Up Phase 1 · Mon 22 Apr – Fri 25 Apr 2026</p>
              </div>
            </div>
            <div className="flex items-center gap-2">

              <Link href={`/schedule/sydney/week-3`} className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-700 hover:bg-slate-600 text-slate-300 text-xs font-semibold rounded-lg transition-colors">
              ...
              <Link href={`/schedule/sydney/week-5`} className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-700 hover:bg-slate-600 text-slate-300 text-xs font-semibold rounded-lg transition-colors">
...
export default function SydneyWeek4Page() {
  return (
