      ...
      <div className="max-w-4xl mx-auto px-4 py-12 sm:py-20">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
          ...
          <div className="space-y-4">
            {(() => {
              ...
              const NO_SCORECARD_SLUGS = ["dasha-axenova", "jeremy-valiente", "shani-thomas", "khushi-patel"];
              return ["jeremy-valiente", "dasha-axenova", "shani-thomas", "khushi-patel"]
        ...
        <div className="space-y-4">
          ...
          {(() => {
            ...
            const CS_SLUGS = ["jeremy-valiente", "dasha-axenova", "shani-thomas", "khushi-patel"];
