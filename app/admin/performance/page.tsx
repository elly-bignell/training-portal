    ...
    <main className="min-h-screen bg-slate-100">
      ...
      <header className="bg-slate-900 text-white">
        <div className="max-w-[1900px] mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2"><Link href="/admin/performance-summary" className="px-3 py-1.5 bg-emerald-600 text-white text-xs font-bold rounded-lg hover:bg-emerald-700 transition-colors">📊 vs Projections</Link><div className="flex items-center gap-2"><Link href="/admin/performance-summary" className="px-3 py-1.5 bg-emerald-600 text-white text-xs font-bold rounded-lg hover:bg-emerald-700 transition-colors">📊 vs Projections</Link><div className="flex items-center gap-2"><Link href="/admin/performance-summary" className="px-3 py-1.5 bg-emerald-600 text-white text-xs font-bold rounded-lg hover:bg-emerald-700 transition-colors">📊 vs Projections</Link><Link href="/roadmap" className="text-xs text-slate-400 hover:text-white">Standards →</Link></div></div></div>
        </div>
      </header>
