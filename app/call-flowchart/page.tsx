      ...
      <div id="rebooking-call" className="mt-16">
        <div className="border-t-2 border-gray-100 pt-12">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-2 bg-orange-100 text-orange-700 text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider mb-4">
              📅 Rebooking Call
            </div>
            <h2 className="text-3xl font-bold text-gray-900 mb-2">Rebooking Call</h2>
            <p className="text-gray-500 text-base">For booked meetings that were rescheduled or missed</p>
          </div>

          {/* Type selector */}
          <div className="grid grid-cols-2 gap-3 mb-8">
            <button
              onClick={() => { setRebookingType('noshow'); setNoShowResponse(null); setNoShowReason(null); }}
              className={`p-5 rounded-2xl border-2 text-sm font-semibold transition-all text-center cursor-pointer ${
            ...
            >
              ...
              <div className="font-bold">No Show</div>
              <div className="text-xs font-normal text-gray-400 mt-1">Prospect didn&apos;t attend</div>
            </button>
            <button
              onClick={() => { setRebookingType('reschedule'); setRescheduleResponse(null); setRescheduleReason(null); }}
              className={`p-5 rounded-2xl border-2 text-sm font-semibold transition-all text-center cursor-pointer ${
            ...
            >
              <div className="text-2xl mb-2">📅</div>
              <div className="font-bold">Reschedule</div>
              <div className="text-xs font-normal text-gray-400 mt-1">No new time locked in</div>
            </button>
          </div>
          ...
          {rebookingType === 'noshow' && (
            <div>
              <div className="flex justify-center my-3 text-gray-300 text-xl">↓</div>

              {/* Intro card */}
              <div className="mb-2">
                <div className="text-[10px] font-bold tracking-widest uppercase text-orange-500 mb-1">SAY</div>
                <div className="bg-amber-50 border border-amber-200 rounded-xl p-5">
                  <h3 className="font-bold text-gray-900 text-sm mb-3">Introduction</h3>
                  <p className="text-gray-700 text-sm leading-relaxed mb-3">
                    &ldquo;Hey [Name], it&apos;s [Rep Name] here from Marketing Sweet. How are you going?&rdquo;
                  </p>
                  <p className="text-gray-400 text-xs italic mb-3">If they respond positively, continue.</p>
              ...
              {/* Decision: what do they say */}
              <div className="mb-2">
                <div className="text-[10px] font-bold tracking-widest uppercase text-gray-400 mb-1">DECISION</div>
                <div className="bg-gray-50 border border-gray-200 rounded-xl p-5">
                  <h3 className="font-bold text-gray-700 text-sm mb-4">What do they say?</h3>
                  <div className="grid grid-cols-2 gap-2">
                    <button
                      onClick={() => setNoShowResponse('interested')}
                      className={`py-3 px-4 rounded-xl text-sm font-semibold border-2 transition-all ${
                        noShowResponse === 'interested'
                    ...
                    <button
                      onClick={() => { setNoShowResponse('not-interested'); setNoShowReason(null); }}
                      className={`py-3 px-4 rounded-xl text-sm font-semibold border-2 transition-all ${
                        noShowResponse === 'not-interested'
              ...
              {noShowResponse === 'interested' && (
                <div>
                  ...
                  <div className="mb-2">
                    <div className="text-[10px] font-bold tracking-widest uppercase text-orange-500 mb-1">SAY</div>
                    <div className="bg-amber-50 border border-amber-200 rounded-xl p-5">
                      <h3 className="font-bold text-gray-900 text-sm mb-3">Rebook the Meeting</h3>
                      <p className="text-gray-700 text-sm leading-relaxed mb-3">
                      ...
                      <p className="text-gray-400 text-xs italic mb-3">If they can&apos;t do that time:</p>
                      <p className="text-gray-700 text-sm leading-relaxed mb-3">
                        &ldquo;Yeah, sure thing. When&apos;s good for you? I&apos;ll try to work around you.&rdquo;
                      </p>
                      <p className="text-gray-400 text-xs italic mb-3">If needed, guide them toward specific options:</p>
                      <p className="text-gray-700 text-sm leading-relaxed mb-3">
                  ...
                  <div className="mb-2">
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-xl p-5">
                      <h3 className="font-bold text-gray-900 text-sm mb-3">Confirm the Rebooking</h3>
                      <p className="text-gray-700 text-sm leading-relaxed">
              ...
              {noShowResponse === 'not-interested' && (
                <div>
                  ...
                  <div className="mb-2">
                    <div className="text-[10px] font-bold tracking-widest uppercase text-orange-500 mb-1">SAY</div>
                    <div className="bg-amber-50 border border-amber-200 rounded-xl p-5">
                      <h3 className="font-bold text-gray-900 text-sm mb-3">Initial Pushback</h3>
                      <p className="text-gray-700 text-sm leading-relaxed">
                  ...
                  <div className="mb-2">
                    <div className="text-[10px] font-bold tracking-widest uppercase text-gray-400 mb-1">DECISION</div>
                    <div className="bg-gray-50 border border-gray-200 rounded-xl p-5">
                      <h3 className="font-bold text-gray-700 text-sm mb-4">What&apos;s the reason?</h3>
                      <div className="grid grid-cols-2 gap-2">
                        <button
                          onClick={() => setNoShowReason('timing')}
                          className={`py-3 px-4 rounded-xl text-sm font-semibold border-2 transition-all ${
                            noShowReason === 'timing'
                        ...
                        <button
                          onClick={() => setNoShowReason('no-interest')}
                          className={`py-3 px-4 rounded-xl text-sm font-semibold border-2 transition-all ${
                            noShowReason === 'no-interest'
                              ? 'border-red-400 bg-red-50 text-red-700'
                              : 'border-gray-200 bg-white text-gray-600 hover:border-red-300'
                          }`}
                        >
                          🚫 No interest / changed mind
                        </button>
                      </div>
                    </div>
                  </div>

                  {/* PATH 1B(i): TIMING OFF */}
                  {noShowReason === 'timing' && (
                    <div>
                      <div className="flex justify-center my-3 text-gray-300 text-xl">↓</div>
                      <div className="mb-2">
                      ...
                      <div className="mb-2">
                        ...
                        <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-5">
                          <h3 className="font-bold text-gray-900 text-sm mb-3">Future Follow Up</h3>
                          <p className="text-gray-700 text-sm leading-relaxed">
                  ...
                  {/* PATH 1B(ii): NO INTEREST / CHANGED MIND */}
                  {noShowReason === 'no-interest' && (
                    <div>
                      <div className="flex justify-center my-3 text-gray-300 text-xl">↓</div>
                      <div className="mb-2">
                        ...
                        <div className="bg-amber-50 border border-amber-200 rounded-xl p-5">
                          ...
                          <p className="text-gray-400 text-xs italic">Acknowledge any objection briefly — the goal isn&apos;t to push hard.</p>
                        </div>
                      </div>
                      <div className="flex justify-center my-3 text-gray-300 text-xl">↓</div>
                      <div className="mb-2">
                        ...
                        <div className="bg-gray-50 border border-gray-200 rounded-xl p-5">
                          <h3 className="font-bold text-gray-900 text-sm mb-3">Leave Door Open</h3>
                          <p className="text-gray-700 text-sm leading-relaxed">
          ...
          {rebookingType === 'reschedule' && (
            <div>
              ...
              {/* Decision: still looking to rebook */}
              <div className="mb-2">
                <div className="text-[10px] font-bold tracking-widest uppercase text-gray-400 mb-1">DECISION</div>
                <div className="bg-gray-50 border border-gray-200 rounded-xl p-5">
                  <h3 className="font-bold text-gray-700 text-sm mb-4">Are they still looking to rebook?</h3>
                  <div className="grid grid-cols-2 gap-2">
                    <button
                      onClick={() => setRescheduleResponse('yes')}
                      className={`py-3 px-4 rounded-xl text-sm font-semibold border-2 transition-all ${
                        rescheduleResponse === 'yes'
                          ? 'border-green-500 bg-green-50 text-green-700'
                          : 'border-gray-200 bg-white text-gray-600 hover:border-green-300'
                      }`}
                    >
                    ...
                    <button
                      onClick={() => { setRescheduleResponse('not-now'); setRescheduleReason(null); }}
                      className={`py-3 px-4 rounded-xl text-sm font-semibold border-2 transition-all ${
                        rescheduleResponse === 'not-now'
                          ? 'border-yellow-500 bg-yellow-50 text-yellow-700'
                          : 'border-gray-200 bg-white text-gray-600 hover:border-yellow-300'
                      }`}
                    >
              ...
              {rescheduleResponse === 'yes' && (
                <div>
                  ...
                  <div className="mb-2">
                    <div className="text-[10px] font-bold tracking-widest uppercase text-orange-500 mb-1">SAY</div>
                    <div className="bg-amber-50 border border-amber-200 rounded-xl p-5">
                      <h3 className="font-bold text-gray-900 text-sm mb-3">Offer New Times</h3>
                      <p className="text-gray-700 text-sm leading-relaxed mb-3">
                        &ldquo;Perfect. How are you looking towards the end of the week — like Thursday morning?&rdquo;
                      </p>
                      <p className="text-gray-400 text-xs italic mb-3">If that works:</p>
                      <p className="text-gray-700 text-sm leading-relaxed">
                  ...
                  <div className="mb-2">
                    <div className="text-[10px] font-bold tracking-widest uppercase text-green-600 mb-1">BOOK</div>
                    <div className="bg-green-50 border border-green-200 rounded-xl p-5">
                      <h3 className="font-bold text-gray-900 text-sm mb-3">Confirm New Time</h3>
                      <p className="text-gray-700 text-sm leading-relaxed">
              ...
              {rescheduleResponse === 'not-now' && (
                <div>
                  ...
                  <div className="mb-2">
                    <div className="text-[10px] font-bold tracking-widest uppercase text-orange-500 mb-1">SAY</div>
                    <div className="bg-amber-50 border border-amber-200 rounded-xl p-5">
                      <h3 className="font-bold text-gray-900 text-sm mb-3">Clarify Timing</h3>
                      <p className="text-gray-700 text-sm leading-relaxed">
                  ...
                  <div className="mb-2">
                    <div className="text-[10px] font-bold tracking-widest uppercase text-gray-400 mb-1">DECISION</div>
                    <div className="bg-gray-50 border border-gray-200 rounded-xl p-5">
                      <h3 className="font-bold text-gray-700 text-sm mb-4">What do they mean?</h3>
                      <div className="grid grid-cols-2 gap-2">
                        <button
                          onClick={() => setRescheduleReason('later')}
                          className={`py-3 px-4 rounded-xl text-sm font-semibold border-2 transition-all ${
                            rescheduleReason === 'later'
                              ? 'border-yellow-500 bg-yellow-50 text-yellow-700'
                              : 'border-gray-200 bg-white text-gray-600 hover:border-yellow-300'
                          }`}
                        >
                        ...
                        <button
                          onClick={() => setRescheduleReason('not-interested')}
                          className={`py-3 px-4 rounded-xl text-sm font-semibold border-2 transition-all ${
                            rescheduleReason === 'not-interested'
                              ? 'border-red-400 bg-red-50 text-red-700'
                              : 'border-gray-200 bg-white text-gray-600 hover:border-red-300'
                          }`}
                        >
                  ...
                  {rescheduleReason === 'later' && (
                    <div>
                      ...
                      <div className="mb-2">
                        <div className="text-[10px] font-bold tracking-widest uppercase text-yellow-600 mb-1">FOLLOW UP</div>
                        <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-5">
                          <h3 className="font-bold text-gray-900 text-sm mb-3">Set Follow Up</h3>
                          <p className="text-gray-700 text-sm leading-relaxed">
                  ...
                  {/* PATH 2B(ii): NO LONGER INTERESTED */}
                  {rescheduleReason === 'not-interested' && (
                    <div>
                      <div className="flex justify-center my-3 text-gray-300 text-xl">↓</div>
                      <div className="mb-2">
                      ...
                      <div className="mb-2">
                        <div className="text-[10px] font-bold tracking-widest uppercase text-gray-500 mb-1">CLOSE</div>
                        <div className="bg-gray-50 border border-gray-200 rounded-xl p-5">
                          <h3 className="font-bold text-gray-900 text-sm mb-3">Close Out Politely</h3>
                          <p className="text-gray-700 text-sm leading-relaxed">
          ...
          {/* Reference footer */}
          <p className="text-xs text-gray-400 mt-10 text-center italic">Rebooking Call &mdash; Supplementary Script</p>
