    ...
    <div className="space-y-0">
      ...
      <div className="grid grid-cols-2 gap-8 max-w-5xl mx-auto items-start">
        ...
        <div>
          ...
          <div className="border border-t-0 border-emerald-100 rounded-b-xl bg-white p-5">
            <FlowCard
            ...
            <div className="grid grid-cols-2 gap-5 items-start">
              ...
              <div>
                ...
                <div className="border border-t-0 border-slate-200 rounded-b-lg p-4 bg-slate-50/30">
                  <FlowCard
        ...
        <div>
          ...
          <div className="border border-t-0 border-orange-100 rounded-b-xl bg-white p-5">
            <FlowCard
