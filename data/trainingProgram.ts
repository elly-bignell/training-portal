...
export const trainingProgram: Module[] = [
  ...
  {
    id: "module-2",
    title: "MODULE 2 — Marketing Sweet Products (M-Quote Memberships)",
    purpose:
      "Understand our core membership products and learn how to recommend the right solution based on client needs.",
    proficiency: [
      ...
      "Articulate pricing structure and value proposition",
    ],
    deliverable:
    ...
    checklist: [
      {
        id: "m2-item1",
        label: "Read the Web Support membership overview",
        link: "#",
        estimatedTime: "15 min",
      },
      {
        id: "m2-item2",
        label: "Read the SEO Support membership overview",
        link: "#",
        estimatedTime: "15 min",
      },
      {
        id: "m2-item3",
        label: "Read the Digital Support membership overview",
        link: "#",
        estimatedTime: "15 min",
      },
      {
        id: "m2-item4",
        label: "Watch the M-Quote walkthrough video",
        link: "#",
        estimatedTime: "20 min",
      },
      {
        id: "m2-item5",
        label: "Review the pricing sheet",
        link: "#",
        estimatedTime: "10 min",
      },
      {
        id: "m2-item6",
        label: "Complete practice scenario: Which membership for a local bakery?",
        estimatedTime: "15 min",
      },
      {
        id: "m2-item7",
        label: "Complete practice scenario: Which membership for an e-commerce store?",
        estimatedTime: "15 min",
      },
      {
        id: "m2-item8",
    ...
    resources: [
      { label: "M-Quote System", url: "#" },
      { label: "Membership Comparison PDF", url: "#" },
      { label: "Client Success Stories", url: "#" },
    ],
  },
  {
    id: "module-3",
