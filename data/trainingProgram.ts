...
export const trainingProgram: Module[] = [
  ...
  },
  {
    ...
    purpose:
      "Explore M-Quote, our quoting and sales system, and learn about our membership products and extras. Login: https://app.m-quote.com.au | Password: MQuote0101",
    proficiency: [
    ...
    checklist: [
      ...
      {
        id: "m2-item2",
        label: "📄 Web Support: View the PDF Breakdown",
        link: "https://app.m-quote.com.au/pdf/Web-Support.pdf#zoom=150",
        estimatedTime: "10 min",
      },
      {
        id: "m2-item3",
        label: "🎧 Web Support: Read Short Description, Listen to Explainer & Podcast, Watch Presentation",
        link: "https://app.m-quote.com.au/",
        estimatedTime: "20 min",
      },
      {
        id: "m2-item4",
        label: "📖 Web Support: Read the Long Description",
        link: "https://app.m-quote.com.au/web-support",
        estimatedTime: "10 min",
      },
      {
        id: "m2-item5",
        label: "📄 SEO Support: View the PDF Breakdown",
        link: "https://app.m-quote.com.au/pdf/SEO-Support.pdf#zoom=150",
        estimatedTime: "10 min",
      },
      {
        id: "m2-item6",
        label: "🎧 SEO Support: Read Short Description, Listen to Explainer & Podcast, Watch Presentation",
        link: "https://app.m-quote.com.au/",
        estimatedTime: "20 min",
      },
      {
        id: "m2-item7",
        label: "📖 SEO Support: Read the Long Description",
        link: "https://app.m-quote.com.au/seo-support",
        estimatedTime: "10 min",
      },
      {
        id: "m2-item8",
        label: "📄 Digital Support: View the PDF Breakdown",
        link: "https://app.m-quote.com.au/pdf/Digital-Support.pdf#zoom=150",
        estimatedTime: "10 min",
      },
      {
        id: "m2-item9",
        label: "🎧 Digital Support: Read Short Description, Listen to Explainer & Podcast, Watch Presentation",
        link: "https://app.m-quote.com.au/",
        estimatedTime: "20 min",
      },
      {
        id: "m2-item10",
        label: "📖 Digital Support: Read the Long Description",
