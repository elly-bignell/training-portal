...
export const CHECKLIST_SECTIONS: ChecklistSection[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { kind: "item", id: "pm-confirmed-attended", number: 11, label: "Confirmed Meetings Attended & Deals Closed for today" },
      { kind: "item", id: "pm-commissions",       number: 12, label: "Commissions updated" },
      { kind: "item", id: "pm-cd-dollars",        number: 13, label: "CD Dollars up to date in trays" },
      { kind: "item", id: "pm-11",                number: 14, label: "All No shows/Reschedules added to next day rebooking schedule" },
      { kind: "item", id: "pm-12",                number: 15, label: "Review meetings for tomorrow" },
      { kind: "item", id: "pm-13",                number: 16, label: "Discuss pipeline with Buddy (to be closed & upcoming meetings)" },
      { kind: "item", id: "pm-14",                number: 17, label: "Add questions / problems for the day to Question Box (https://training-portal-mauve.vercel.app/question-box)" },
      { kind: "item", id: "pm-15",                number: 18, label: "EOD Discord message sent" },
    ],
  },
];
